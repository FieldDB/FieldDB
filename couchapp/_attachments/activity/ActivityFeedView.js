...
//        }, activityfeedself);
    ...
    render : function() {
      ...
      if (this.format == "rightSideUser") {
        ...
        $(this.el).find(".locale_Refresh_Activities").attr("title", Locale.get("locale_Refresh_Activities"));
        $(this.el).find(".locale_Hide_Activities").attr("title", Locale.get("locale_Hide_Activities"));
        $(this.el).find(".locale_Activity_Feed").html(Locale.get("locale_Activity_Feed_Your"));
        ...
        $(this.el).find(".locale_Refresh_Activities").attr("title", Locale.get("locale_Refresh_Activities"));
        $(this.el).find(".locale_Hide_Activities").attr("title", Locale.get("locale_Hide_Activities"));
        $(this.el).find(".locale_Activity_Feed").html(Locale.get("locale_Activity_Feed_Team"));
        ...
        $(this.el).find(".locale_Show_Activities").attr("title", Locale.get("locale_Show_Activities"));
        $(this.el).find(".locale_Activity_Feed").html(Locale.get("locale_Activity_Feed_Your"));
