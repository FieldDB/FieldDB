...
var addRoleToUser = function(dbConnection, username, roles, successcallback, errorcallback){
  ...
  usersdb.get(userid, function(err, doc) {
    var userold = doc;
    console.log(new Date() + " These are the users's details before adding a role."
      ...
      .create(function(err, res) {
        ...
        db.save("_security", securityParamsforNewDB,
          ...
          if (err != null || !doc.ok) {
            ...
            console.log(new Date()+ " _security created");
          }
        });
        ...
        db.save("_design/blockNonContribAdminWrites", {
          ...
          if (err != null || !doc.ok) {
            ...
            console.log(new Date()+ " blockNonContribAdminWrites created");
          }
        });
