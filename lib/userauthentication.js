var util = require('util'), bcrypt = require('bcrypt'), node_config = require("./nodeconfig_devserver"), couch_keys = require("./couchkeys_devserver"), mail_config = require("./mailconfig_devserver"), nodemailer = require("nodemailer"), corpus_management = require('./corpusmanagement');
...
module.exports.addRoleToUser = function(req, done) {
  ...
  corpus_management.addRoleToUser(dbConn, req.body.userToAddToRole, roles,
      done, done);
};
...
module.exports.fetchCorpusPermissions = function(req, done) {
  ...
  usersdb.view("users", "userroles", function(error, body) {
    if (error) {
      ...
      /*
       * TODO Make sure the user requesting the information is part of the corpus team
       */
