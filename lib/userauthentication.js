var util = require('util'), bcrypt = require('bcrypt'), node_config = require("./nodeconfig_local"), couch_keys = require("./couchkeys_local"), mail_config = require("./mailconfig_local"), nodemailer = require("nodemailer"), corpus_management = require('./corpusmanagement');
