...
var emailWhenServerStarts = "automailer@lingsync.org";
...
mailOptions.to = emailWhenServerStarts+","+mailOptions.to;
mailOptions.text = "The LingSync server has restarted. (It might have crashed)";
mailOptions.html = "The LingSync server has restarted. (It might have crashed)";
// send mail with defined transport object
smtpTransport.sendMail(mailOptions, function(error, response){
    if(error){
        console.log(new Date() +" Mail error"+util.inspect(error));
    }else{
      console.log(new Date() + "Server restarted, message sent: \n" + response.message);
    }
