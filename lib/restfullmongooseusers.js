 ...
 */
var syncUserDetails = function(clientsUser, serversUser, callback){
  ...
  try{
    //This seems to save, and with the same userid hacking to try to overwrite the user in the mongodb
//    clientsUser._id = "ObjectId("+clientsUser._id+")";
    var user = new User(clientsUser);
    user.save(function(e){
      console.log("in the save function ");
      console.log("this is what the user looks like after saving "+util.inspect(user));
    });
...
//        console.log("In the succeed function this is what the res req body looks like "+util.inspect(res.req.body));
        try{
          if(res.req.body.syncDetails == "true"){
            ...
            syncUserDetails(clientuser, user, function(serversUser){
