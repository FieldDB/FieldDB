  ...
  db.exists(function (err, exists) {
    if (err) {
      ...
      .create(function(err, res) {
         ...
         * -signed in ifieldusers can read other user's
...
var UserSchema = new Schema({
  ...
  affiliation: String,
  emailaddress: String, /*if we use email mongoose will try to use that as a key which is not how we set up our app*/
  authUrl: String,
  description: String,
  subtitle: String,
  corpuses: Array,
