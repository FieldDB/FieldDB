...
var c = new cradle.Connection(couchkeys.url, 5984, {
  auth: { username: couchkeys.username, password: couchkeys.password}
});

var createDbaddUser = function(dbname, user, successcallback, errorcallback){
  console.log("Creating a new database/corpus: "+dbname);
