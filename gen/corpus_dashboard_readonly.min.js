...
if (e.errors != null) {
                ...
                error: function(e) {
                    Utils.debug("Ajax failed, user might be offline (or server might have crashed before replying).", e), window.appView && window.appView.toastUser("There was an error in contacting the authentication server to confirm your identity. " + Utils.contactUs, "alert-danger", "Connection errors:"), typeof n == "function" && n("There was an error in contacting the authentication server to confirm your identity. Maybe you're offline?");
                },
                dataType: ""
