...
,
        ...
        render: function() {
            ...
            if (this.format == "corpus") $(this.el).html(this.templateSettings(this.model.toJSON())), $(this.el).find(".locale_Encrypt_if_confidential").html(chrome.i18n.getMessage("locale_Encrypt_if_confidential")), $(this.el).find(".locale_Help_Text").html(chrome.i18n.getMessage("locale_Help_Text")), $(this.el).find(".locale_Help_Text_Placeholder").attr("placeholder", chrome.i18n.getMessage("locale_Help_Text_Placeholder")), this.$el.children(".choose-field").val(this.model.get("label")); else if (this.format == "datum") {
...
(this.templateSummary(e)), $(this.el).find(".locale_Show_Readonly").attr("title", chrome.i18n.getMessage("locale_Show_Readonly")), $(this.el).find(".locale_Show_fullscreen").attr("title", chrome.i18n.getMessage("locale_Show_fullscreen")), $(this.el).find(".locale_Elicitation_Session").html(chrome.i18n.getMessage("locale_Elicitation_Session")), $(this.el).find(".locale_Goal").html(chrome.i18n.getMessage("locale_Goal")), $(this.el).find(".locale_Consultants").html(chrome.i18n.getMessage("locale_Consultants")), $(this.el).find(".locale_When").html(chrome.i18n.getMessage("locale_When"));
                }
...
($("#user-fullscreen")), $(this.el).html(this.fullscreenTemplate(this.model.toJSON())), $(this.el).find(".locale_User_Profile").html(chrome.i18n.getMessage("locale_Private_Profile")), this.corpusesReadView.el = $(this.el).find(".corpuses"), this.corpusesReadView.render(); else if (this.format == "modal") Utils.debug("USER READ MODAL render: "), this.setElement($("#user-modal")), $(this.el).html(this.modalTemplate(this.model.toJSON())), $(this.el).find(".locale_Edit_User_Profile_Tooltip").attr("title", chrome.i18n.getMessage("locale_Edit_User_Profile_Tooltip")), $(this.el).find(".locale_View_Public_Profile_Tooltip").html(chrome.i18n.getMessage("locale_View_Public_Profile_Tooltip")), $(this.el).find(".locale_Private_Profile_Instructions").html(chrome.i18n.getMessage("locale_Private_Profile_Instructions")), $(this.el).find(".locale_Close").html(chrome.i18n.getMessage("locale_Close")), $(this.el).find(".locale_User_Profile").html(chrome.i18n.getMessage("locale_Private_Profile")), this.corpusesReadView
.el = $(this.el).find(".corpuses"), this.corpusesReadView.render(); else if (this.format == "link") Utils.debug("USER READ LINK render: "), $(this.el).html(this.linkTemplate(this.model.toJSON())), $(this.el).find(".locale_View_Profile_Tooltip").attr("title", chrome.i18n.getMessage("locale_View_Profile_Tooltip")); else {
                if (this.format != "public") throw "The UserReadView doesn't know what format to display, you need to tell it a format";
                Utils.debug("USER READ PUBLIC render: "), this.setElement($("#public-user-page")), $(this.el).html(this.fullscreenTemplate(this.model.toJSON())), $(this.el).find(".locale_Edit_Public_User_Profile").attr("title", chrome.i18n.getMessage("locale_Edit_Public_User_Profile")), $(this.el).find(".locale_User_Profile").html(chrome.i18n.getMessage("locale_Public_Profile")), this.corpusesReadView.el = $(this.el).find(".corpuses"), this.corpusesReadView.render();
            }
            return this.format != "link" && ($(this.el).
find(".locale_Gravatar").html(chrome.i18n.getMessage("locale_Gravatar")), $(this.el).find(".locale_Email").html(chrome.i18n.getMessage("locale_Email")), $(this.el).find(".locale_Research_Interests").html(chrome.i18n.getMessage("locale_Research_Interests")), $(this.el).find(".locale_Affiliation").html(chrome.i18n.getMessage("locale_Affiliation")), $(this.el).find(".locale_Description").html(chrome.i18n.getMessage("locale_Description")), $(this.el).find(".locale_Corpora").html(chrome.i18n.getMessage("locale_Corpora"))), this;
        },
        changeViewsOfInternalModels: function() {
...
,
        ...
        renderUpdatedPaginationControl: function() {
            ...
            this.el.parent().find(".nextinfinitepagination"
                ...
                e.changeCount(t, e);
            }), this.el.parent().find(".pagination-control").find(".locale_More").html(chrome.i18n.getMessage("locale_More")), this.el.parent().find(".pagination-control").find(".locale_Show").html(chrome.i18n.getMessage("locale_Show")), this.el.parent().find(".pagination-control").find(".locale_per_page").html(chrome.i18n.getMessage("locale_per_page")), this.el.parent().find
(".pagination-control").find(".locale_of").html(chrome.i18n.getMessage("locale_of")), this.el.parent().find(".pagination-control").find(".locale_pages_shown").html(chrome.i18n.getMessage("locale_pages_shown"));
        },
        perPage: 10,
...
setElement($("#activity-feed-user")), $(this.el).html(this.template(this.model.toJSON())), this.activitiesView.el = this.$(".activities-updating-collection"), this.activitiesView.render(), $(this.el).find(".locale_Refresh_Activities").attr("title", chrome.i18n.getMessage("locale_Refresh_Activities")), $(this.el).find(".locale_Hide_Activities").attr("title", chrome.i18n.getMessage("locale_Hide_Activities")), $(this.el).find(".locale_Activity_Feed").html(chrome.i18n.getMessage("locale_Activity_Feed_Your"))) : this.format == "rightSideCorpusTeam" ? (this.changeViewsOfInternalModels(), this.setElement($("#activity-feed-corpus-team")), $(this.el).html(this.template(this.model.toJSON())), this.activitiesView.el = this.$(".activities-updating-collection"), this.activitiesView.render(), $(this.el).find(".locale_Refresh_Activities").attr("title", chrome.i18n.getMessage("locale_Refresh_Activities")), $(this.el).find(".locale_Hide_Activities").attr("title", chrome.i18n.getMessage("locale_Hide_Activities"
)), $(this.el).find(".locale_Activity_Feed").html(chrome.i18n.getMessage("locale_Activity_Feed_Team"))) : this.format == "minimizedrightSideUser" ? (this.setElement($("#activity-feed-user")), $(this.el).html(this.minimizedTemplate(this.model.toJSON())), $(this.el).find(".locale_Show_Activities").attr("title", chrome.i18n.getMessage("locale_Show_Activities")), $(this.el).find(".locale_Activity_Feed").html(chrome.i18n.getMessage("locale_Activity_Feed_Your"))) : this.format == "minimizedrightSideCorpusTeam" && (this.setElement($("#activity-feed-corpus-team")), $(this.el).html(this.minimizedTemplate(this.model.toJSON())), $(this.el).find(".locale_Show_Activities").attr("title", chrome.i18n.getMessage("locale_Show_Activities")), $(this.el).find(".locale_Activity_Feed").html(chrome.i18n.getMessage("locale_Activity_Feed_Team"))), this;
        },
        destroy_view: function() {
...
()) : $("#user-quickview").html('<i class="icons icon-user icon-white">'), this.$el.children(".user").html("")), $(this.el).find(".locale_Username").html(chrome.i18n.getMessage("locale_Username")), $(this.el).find(".locale_Password").html(chrome.i18n.getMessage("locale_Password")), $(this.el).find(".locale_Log_Out").html(chrome.i18n.getMessage("locale_Log_Out")), $(this.el).find(".locale_Log_In").html(chrome.i18n.getMessage("locale_Log_In")), $(this.el).find(".locale_Private_Profile").html(chrome.i18n.getMessage("locale_Private_Profile")), $(this.el).find(".locale_User_Settings").html(chrome.i18n.getMessage("locale_User_Settings")), $(this.el).find(".locale_Keyboard_Shortcuts").html(chrome.i18n.getMessage("locale_Keyboard_Shortcuts")), $(this.el).find(".locale_Corpus_Settings").html(chrome.i18n.getMessage("locale_Corpus_Settings")), $(this.el).find(".locale_Terminal_Power_Users").html(chrome.i18n.getMessage("locale_Terminal_Power_Users")), document.getElementById("authUrl").value = Utils
.authUrl, this);
        },
        logout: function() {
...
(), u = this.userView.model, this.model.set({
        ...
        showQuickAuthenticateView: function(e, t, n, r) {
            var i = this;
            this.model.get("userPrivate").get("username") == "sapir" ? ($("#quick-authenticate-modal").modal("show"), $("#quick-authenticate-password").val("phoneme"), window.hub.subscribe("quickAuthenticationClose", function() {
...
), $(this.el).find(".locale_Encrypt_if_confidential").html(chrome.i18n.getMessage("locale_Encrypt_if_confidential")); else if (this.format == "datum") {
                var e = this.model.toJSON();
                e.helpText = !0, $(this.el).html(this.templateValue(e));
            } else if (this.format == "session") {
                var e = this.model.toJSON();
...
label: "consultants"
                    ...
                    $(this.el).html(this.templateLink(e)), $(this.el).find(".locale_Goal").html(chrome.i18n.getMessage("locale_Goal")), $(this.el).find(".locale_Consultants").html(chrome.i18n.getMessage("locale_Consultants"));
                }
            } catch (t) {
                Utils.debug("There was a problem rendering the session, probably the datumfields are still arrays and havent been restructured yet.");
            }
...
.destroy_view());
            var e = this.model.toJSON();
            e.datumCount = this.model.get("datumIds").length, e.decryptedMode = window.app.get("corpus").get("confidential").decryptedMode, this.format == "link" ? (Utils.debug("DATALIST READ LINK render: "), $(this.el).html(this.templateLink(e))) : this.format == "leftSide" ? (Utils.debug("DATALIST READ LEFTSIDE render: "), this.setElement($("#data-list-quickview-header")), $(this.el).html(this.templateSummary(e)), window.appView.currentPaginatedDataListDatumsView.renderInElement($("#data-list-quickview").find(".current-data-list-paginated-view")), $(this.el).find(".locale_Hide_Datalist").attr("title", chrome.i18n.getMessage("locale_Hide_Datalist")), $(this.el).find(".locale_Edit_Datalist").attr("title", chrome.i18n.getMessage("locale_Edit_Datalist")), $(this.el).find(".locale_Show_fullscreen").attr("title", chrome.i18n.getMessage("locale_Show_fullscreen"))) : this.format == "fullscreen" ? (Utils.debug("DATALIST READ FULLSCREEN render: "
), this.setElement($("#data-list-fullscreen-header")), $(this.el).html(this.templateFullscreen(e)), window.appView.currentPaginatedDataListDatumsView.renderInElement($("#data-list-fullscreen").find(".current-data-list-paginated-view")), $(this.el).find(".locale_Edit_Datalist").attr("title", chrome.i18n.getMessage("locale_Edit_Datalist")), $(this.el).find(".locale_Show_in_Dashboard").attr("title", chrome.i18n.getMessage("locale_Show_in_Dashboard"))) : this.format == "centerWell" ? (Utils.debug("DATALIST READ CENTER render: "), this.setElement($("#data-list-embedded-header")), $(this.el).html(this.templateEmbedded(e)), window.appView.currentPaginatedDataListDatumsView.renderInElement($("#data-list-embedded").find(".current-data-list-paginated-view")), $(this.el).find(".locale_Edit_Datalist").attr("title", chrome.i18n.getMessage("locale_Edit_Datalist")), $(this.el).find(".locale_Show_in_Dashboard").attr("title", chrome.i18n.getMessage("locale_Show_in_Dashboard"))) : this.format == "minimized" && 
(Utils.debug("DATALIST READ MINIMIZED render: "), this.setElement($("#data-list-quickview-header")), $(this.el).html(this.templateMinimized(e)), $(this.el).find(".locale_Show_Datalist").attr("title", chrome.i18n.getMessage("locale_Show_Datalist")));
            try {
                this.format && this.format.indexOf("minimized") == -1 && (this.commentReadView.el = this.$(".comments"), this.commentReadView.render(), $(this.el).find(".locale_Play_Audio_checked").attr("title", chrome.i18n.getMessage("locale_Play_Audio_checked")), $(this.el).find(".locale_Remove_checked_from_datalist_tooltip").attr("title", chrome.i18n.getMessage("locale_Remove_checked_from_datalist_tooltip")), $(this.el).find(".locale_Plain_Text_Export_Tooltip_checked").attr("title", chrome.i18n.getMessage("locale_Plain_Text_Export_Tooltip_checked")), $(this.el).find(".locale_Encrypt_checked").attr("title", chrome.i18n.getMessage("locale_Encrypt_checked")), $(this.el).find(".locale_Decrypt_checked").attr("title", chrome.i18n
.getMessage("locale_Decrypt_checked")), e.decryptedMode ? $(this.el).find(".locale_Show_confidential_items_Tooltip").attr("title", chrome.i18n.getMessage("locale_Hide_confidential_items_Tooltip")) : $(this.el).find(".locale_Show_confidential_items_Tooltip").attr("title", chrome.i18n.getMessage("locale_Show_confidential_items_Tooltip")), $(this.el).find(".locale_Export_checked_as_LaTeX").attr("title", chrome.i18n.getMessage("locale_Export_checked_as_LaTeX")), $(this.el).find(".locale_Export_checked_as_CSV").attr("title", chrome.i18n.getMessage("locale_Export_checked_as_CSV")), $(this.el).find(".locale_Add").html(chrome.i18n.getMessage("locale_Add")));
            } catch (t) {
...
: "newDatum",
        ...
        render: function() {
            ...
            if (this.format == "leftSide") Utils.debug("CORPUS READ LEFTSIDE render: "), this.setElement($("#corpus-quickview")), $(this.el).html(this.templateSummary(e)), $(this.el).find(".locale_Show_corpus_settings").attr("title", chrome.i18n.getMessage("locale_Show_corpus_settings")); else if (this.format == "link") Utils.debug("CORPUS READ LINK render: "), $(this.el).html(this.templateLink(e)); else if (this.format == "fullscreen") {
                ...
                $(this.el).find(".locale_Show_in_Dashboard").attr("title", chrome.i18n.getMessage("locale_Show_in_Dashboard")), $(this.el).find(".locale_Sessions_associated").html(chrome.i18n.getMessage("locale_Sessions_associated")), $(this.el).find(".locale_elicitation_sessions_explaination").html(chrome.i18n.getMessage("locale_elicitation_sessions_explaination")), $(this.el).find(".locale_Datalists_associated").html(chrome.i18n.getMessage("locale_Datalists_associated")), $(this.el).find(".locale_datalists_explaination").html
(chrome.i18n.getMessage("locale_datalists_explaination")), $(this.el).find(".locale_Permissions_associated").html(chrome.i18n.getMessage("locale_Permissions_associated")), $(this.el).find(".locale_permissions_explaination").html(chrome.i18n.getMessage("locale_permissions_explaination")), $(this.el).find(".locale_Datum_field_settings").html(chrome.i18n.getMessage("locale_Datum_field_settings")), $(this.el).find(".locale_datum_fields_explaination").html(chrome.i18n.getMessage("locale_datum_fields_explaination")), $(this.el).find(".locale_Datum_state_settings").html(chrome.i18n.getMessage("locale_Datum_state_settings")), $(this.el).find(".locale_datum_states_explaination").html(chrome.i18n.getMessage("locale_datum_states_explaination")), $(this.el).find(".locale_Add").html(chrome.i18n.getMessage("locale_Add"));
...
)), $(this.el).find(".locale_datalists_explaination").html(chrome.i18n.getMessage("locale_datalists_explaination")), $(this.el).find(".locale_Permissions_associated").html(chrome.i18n.getMessage("locale_Permissions_associated")), $(this.el).find(".locale_permissions_explaination").html(chrome.i18n.getMessage("locale_permissions_explaination")), $(this.el).find(".locale_Datum_field_settings").html(chrome.i18n.getMessage("locale_Datum_field_settings")), $(this.el).find(".locale_datum_fields_explaination").html(chrome.i18n.getMessage("locale_datum_fields_explaination")), $(this.el).find(".locale_Datum_state_settings").html(chrome.i18n.getMessage("locale_Datum_state_settings")), $(this.el).find(".locale_datum_states_explaination").html(chrome.i18n.getMessage("locale_datum_states_explaination")), $(this.el).find(".locale_Add").html(chrome.i18n.getMessage("locale_Add")));
            return $(this.el).find(".locale_New_menu").html(chrome.i18n.getMessage("locale_New_menu")), $(this.el).find(".locale_New_Datum"
).html(chrome.i18n.getMessage("locale_New_Datum")), $(this.el).find(".locale_New_Data_List").html(chrome.i18n.getMessage("locale_New_Data_List")), $(this.el).find(".locale_New_Session").html(chrome.i18n.getMessage("locale_New_Session")), $(this.el).find(".locale_New_Corpus").html(chrome.i18n.getMessage("locale_New_Corpus")), $(this.el).find(".locale_Data_menu").html(chrome.i18n.getMessage("locale_Data_menu")), $(this.el).find(".locale_Import_Data").html(chrome.i18n.getMessage("locale_Import_Data")), $(this.el).find(".locale_Export_Data").html(chrome.i18n.getMessage("locale_Export_Data")), $(this.el).find(".locale_Edit_corpus").attr("title", chrome.i18n.getMessage("locale_Edit_corpus")), this;
        },
        destroy_view: function() {
...
html(this.templateEmbedded({})), this.datumsView.el = this.$(".datum-embedded-ul"), this.datumsView.render(), $(this.el).find(".locale_Show_fullscreen").attr("title", chrome.i18n.getMessage("locale_Show_fullscreen"))) : this.format == "fullscreen" && (this.setElement($("#datum-container-fullscreen")), $(this.el).html(this.templateFullscreen({})), this.datumsView.el = this.$(".datum-embedded-ul"), this.datumsView.render(), $(this.el).find(".locale_Show_in_Dashboard").attr("title", chrome.i18n.getMessage("locale_Show_in_Dashboard"))), $(this.el).find(".locale_Data_Entry_Area").html(chrome.i18n.getMessage("locale_Data_Entry_Area")), $(this.el).find(".locale_Edit_Datum").attr("title", chrome.i18n.getMessage("locale_Edit_Datum"));
        },
...
{},
    ...
    var r = e.View.extend({
        ...
        render: function() {
            return this.setElement($("#export-modal")), $(this.el).html(this.template(this.model.toJSON())), $(this.el).find(".locale_Export").html(chrome.i18n.getMessage("locale_Export")), $(this.el).find(".locale_Close").html(chrome.i18n.getMessage("locale_Close")), this;
    ...
    var r = e.View.extend({
        ...
        tagName: "span",
        render: function() {
            return Utils.debug("INSERT UNICODE render"), $(this.el).html(this.template(this.model.toJSON())), $(this.el).find(".locale_LaTeX_Code").html(chrome.i18n.getMessage("locale_LaTeX_Code")), $(this.el).find
(".locale_Unicode_Instructions").html(chrome.i18n.getMessage("locale_Unicode_Instructions")), $(this.el).find(".locale_Keyboard_Shortcuts").html(chrome.i18n.getMessage("locale_Keyboard_Shortcuts")), $(this.el).find(".locale_Remove_Unicode").html(chrome.i18n.getMessage("locale_Remove_Unicode")), this;
        },
...
render: function() {
            ...
            }), $(this.el).find(".locale_Hide_Unicode_Palette").attr("title", chrome.i18n.getMessage("locale_Hide_Unicode_Palette")), $(this.el).find(".locale_Paste_Type_Unicode_Symbol_Placeholder").attr("placeholder", chrome.i18n.getMessage("locale_Paste_Type_Unicode_Symbol_Placeholder")), $(this.el).find(".locale_TIPA_shortcut").attr("placeholder", chrome.i18n.getMessage("locale_TIPA_shortcut")), $(this.el).find(".locale_Add_new_symbol").attr("title", chrome.i18n.getMessage("locale_Add_new_symbol")), $(this.el).find(".locale_Add").html(chrome.i18n.getMessage("locale_Add"))) : this.format == "minimized" && 
(this.setElement($("#insert-unicode")), $(this.el).html(this.minimizedTemplate({})), $(this.el).find(".locale_Show_Unicode_Palette").attr("title", chrome.i18n.getMessage("locale_Show_Unicode_Palette"))), $(this.el).find(".locale_Unicode").html(chrome.i18n.getMessage("locale_Unicode")), $(this.el).find(".locale_Drag_and_Drop").html(chrome.i18n.getMessage("locale_Drag_and_Drop")), this;
        },
...
.model.get("alwaysRandomizeSkin") == "true" ? ($(this.el).find(".randomize-backgound").addClass("btn-success"), this.randomSkin()) : $(this.el).find(".randomize-backgound").removeClass("btn-success"), this.model.get("transparentDashboard") == "true" ? ($(this.el).find(".transparent-dashboard").addClass("btn-success"), this.makeDashboardTransparent()) : ($(this.el).find(".transparent-dashboard").removeClass("btn-success"), this.makeDashboardOpaque()), this.model.get("skin") == "" ? this.randomSkin() : this.renderSkin()), $(this.el).find(".locale_User_Settings").html(chrome.i18n.getMessage("locale_User_Settings")), $(this.el).find(".locale_Skin").html(chrome.i18n.getMessage("locale_Skin")), $(this.el).find(".locale_Change_Background").html(chrome.i18n.getMessage("locale_Change_Background")), $(this.el).find(".locale_Background_on_Random").html(chrome.i18n.getMessage("locale_Background_on_Random")), $(this.el).find(".locale_Transparent_Dashboard").html(chrome.i18n.getMessage("locale_Transparent_Dashboard"
)), $(this.el).find(".locale_Number_Datum").html(chrome.i18n.getMessage("locale_Number_Datum")), $(this.el).find(".locale_Close").html(chrome.i18n.getMessage("locale_Close")), this;
        },
        currentSkin: 0,
...
: function(e) {
            ...
            "click .icon-eye-open": function(e) {
                ...
                var n = this;
                return t.turnOnDecryptedMode(function() {
                    n.$el.find(".icon-eye-close").toggleClass("icon-eye-close icon-eye-open"), $(n.el).find(".locale_Show_confidential_items_Tooltip").attr("title", chrome.i18n.getMessage("locale_Hide_confidential_items_Tooltip"));
                }), !1;
            },
            "click .icon-eye-close": function(e) {
                e && (e.stopPropagation(), e.preventDefault());
...
return t || alert("This is a bug: cannot find decryption module for your corpus."), t.turnOffDecryptedMode(), this.$el.find(".icon-eye-open").toggleClass("icon-eye-close icon-eye-open"), $(this.el).find(".locale_Show_confidential_items_Tooltip").attr("title", chrome.i18n.getMessage("locale_Show_confidential_items_Tooltip")), !1;
            }
        },
...
).attr("title", chrome.i18n.getMessage("locale_Remove_checked_from_datalist_tooltip")), $(this.el).find(".locale_Plain_Text_Export_Tooltip_checked").attr("title", chrome.i18n.getMessage("locale_Plain_Text_Export_Tooltip_checked")), $(this.el).find(".locale_Encrypt_checked").attr("title", chrome.i18n.getMessage("locale_Encrypt_checked")), $(this.el).find(".locale_Decrypt_checked").attr("title", chrome.i18n.getMessage("locale_Decrypt_checked")), e.decryptedMode ? $(this.el).find(".locale_Show_confidential_items_Tooltip").attr("title", chrome.i18n.getMessage("locale_Hide_confidential_items_Tooltip")) : $(this.el).find(".locale_Show_confidential_items_Tooltip").attr("title", chrome.i18n.getMessage("locale_Show_confidential_items_Tooltip")), $(this.el).find(".locale_Export_checked_as_LaTeX").attr("title", chrome.i18n.getMessage("locale_Export_checked_as_LaTeX")), $(this.el).find(".locale_Export_checked_as_CSV").attr("title", chrome.i18n.getMessage("locale_Export_checked_as_CSV")), $(this.el)
.find(".locale_Add").html(chrome.i18n.getMessage("locale_Add")); else if (this.format == "fullscreen") Utils.debug("DATALIST EDIT FULLSCREEN render: " + this.el), this.setElement($("#data-list-fullscreen-header")), $(this.el).html(this.templateFullscreen(e)), window.appView.currentPaginatedDataListDatumsView.renderInElement($("#data-list-fullscreen").find(".current-data-list-paginated-view")), $(this.el).find(".locale_Show_Readonly").attr("title", chrome.i18n.getMessage("locale_Show_Readonly")), $(this.el).find(".locale_Show_in_Dashboard").attr("title", chrome.i18n.getMessage("locale_Show_in_Dashboard")), $(this.el).find(".locale_Save").html(chrome.i18n.getMessage("locale_Save")), $(this.el).find(".locale_Play_Audio_checked").attr("title", chrome.i18n.getMessage("locale_Play_Audio_checked")), $(this.el).find(".locale_Remove_checked_from_datalist_tooltip").attr("title", chrome.i18n.getMessage("locale_Remove_checked_from_datalist_tooltip")), $(this.el).find(".locale_Plain_Text_Export_Tooltip_checked"
).attr("title", chrome.i18n.getMessage("locale_Plain_Text_Export_Tooltip_checked")), $(this.el).find(".locale_Encrypt_checked").attr("title", chrome.i18n.getMessage("locale_Encrypt_checked")), $(this.el).find(".locale_Decrypt_checked").attr("title", chrome.i18n.getMessage("locale_Decrypt_checked")), e.decryptedMode ? $(this.el).find(".locale_Show_confidential_items_Tooltip").attr("title", chrome.i18n.getMessage("locale_Hide_confidential_items_Tooltip")) : $(this.el).find(".locale_Show_confidential_items_Tooltip").attr("title", chrome.i18n.getMessage("locale_Show_confidential_items_Tooltip")), $(this.el).find(".locale_Export_checked_as_LaTeX").attr("title", chrome.i18n.getMessage("locale_Export_checked_as_LaTeX")), $(this.el).find(".locale_Export_checked_as_CSV").attr("title", chrome.i18n.getMessage("locale_Export_checked_as_CSV")), $(this.el).find(".locale_Add").html(chrome.i18n.getMessage("locale_Add")); else if (this.format == "centreWell") Utils.debug("DATALIST EDIT CENTER render: " + 
...
.i18n.getMessage("locale_Encrypt_checked")), $(this.el).find(".locale_Decrypt_checked").attr("title", chrome.i18n.getMessage("locale_Decrypt_checked")), e.decryptedMode ? $(this.el).find(".locale_Show_confidential_items_Tooltip").attr("title", chrome.i18n.getMessage("locale_Hide_confidential_items_Tooltip")) : $(this.el).find(".locale_Show_confidential_items_Tooltip").attr("title", chrome.i18n.getMessage("locale_Show_confidential_items_Tooltip")), $(this.el).find(".locale_Export_checked_as_LaTeX").attr("title", chrome.i18n.getMessage("locale_Export_checked_as_LaTeX")), $(this.el).find(".locale_Export_checked_as_CSV").attr("title", chrome.i18n.getMessage("locale_Export_checked_as_CSV")), $(this.el).find(".locale_Add").html(chrome.i18n.getMessage("locale_Add")); else if (this.format == "search") Utils.debug("DATALIST EDIT SEARCH render: " + this.el), this.setElement($("#search-data-list-quickview-header")), $(this.el).html(this.searchTemplate(e)), $("#search-data-list-quickview").addClass
("well"), window.appView.searchEditView.searchPaginatedDataListDatumsView.renderInElement($("#search-data-list-quickview").find(".search-data-list-paginated-view")), $(".search-data-list-paginated-view").show(), $("#search-data-list-quickview-header").parent().find(".pagination-control").show(), $(this.el).find(".locale_Save").html(chrome.i18n.getMessage("locale_Save")), $(this.el).find(".locale_Hide_Datalist").attr("title", chrome.i18n.getMessage("locale_Hide_Datalist")), $(this.el).find(".locale_Play_Audio_checked").attr("title", chrome.i18n.getMessage("locale_Play_Audio_checked")), $(this.el).find(".locale_Remove_checked_from_datalist_tooltip").attr("title", chrome.i18n.getMessage("locale_Remove_checked_from_datalist_tooltip")), $(this.el).find(".locale_Plain_Text_Export_Tooltip_checked").attr("title", chrome.i18n.getMessage("locale_Plain_Text_Export_Tooltip_checked")), $(this.el).find(".locale_Encrypt_checked").attr("title", chrome.i18n.getMessage("locale_Encrypt_checked")), $(this.
el).find(".locale_Decrypt_checked").attr("title", chrome.i18n.getMessage("locale_Decrypt_checked")), e.decryptedMode ? $(this.el).find(".locale_Show_confidential_items_Tooltip").attr("title", chrome.i18n.getMessage("locale_Hide_confidential_items_Tooltip")) : $(this.el).find(".locale_Show_confidential_items_Tooltip").attr("title", chrome.i18n.getMessage("locale_Show_confidential_items_Tooltip")), $(this.el).find(".locale_Export_checked_as_LaTeX").attr("title", chrome.i18n.getMessage("locale_Export_checked_as_LaTeX")), $(this.el).find(".locale_Export_checked_as_CSV").attr("title", chrome.i18n.getMessage("locale_Export_checked_as_CSV")); else if (this.format == "search-minimized") {
...
)) : $(this.el).find(".locale_Show_confidential_items_Tooltip").attr("title", chrome.i18n.getMessage("locale_Show_confidential_items_Tooltip")), $(this.el).find(".locale_Export_checked_as_LaTeX").attr("title", chrome.i18n.getMessage("locale_Export_checked_as_LaTeX")), $(this.el).find(".locale_Export_checked_as_CSV").attr("title", chrome.i18n.getMessage("locale_Export_checked_as_CSV")), $(this.el).find(".locale_Add").html(chrome.i18n.getMessage("locale_Add"))) : this.format == "minimized" ? (Utils.debug("DATALIST EDIT MINIMIZED render: " + this.el), this.setElement($("#data-list-quickview-header")), $(this.el).html(this.templateMinimized(e)), $(this.el).find(".locale_Show_Datalist").attr("title", chrome.i18n.getMessage("locale_Show_Datalist"))) : Utils.debug("Bug: no format was specified for DataListEditView, nothing was rendered");
            try {
                this.format && this.format.indexOf("minimized") == -1 && (this.commentReadView.el = this.$el.find(".comments"), this.commentReadView
.render(), $(this.el).find(".locale_Title").html(chrome.i18n.getMessage("locale_Title")), $(this.el).find(".locale_Description").html(chrome.i18n.getMessage("locale_Description")));
            } catch (t) {
                alert("Bug, there was a problem rendering the contents of the data list format: " + this.format);
            }
            return this;
...
this.format == "fullscreen" ? (this.setElement($("#search-fullscreen")), $(this.el).html(this.fullscreenTemplate(this.model.toJSON()))) : this.format == "centreWell" && (this.setElement($("#search-embedded")), $(this.el).html(this.embeddedTemplate(this.model.toJSON()))), $(this.el).find(".locale_Advanced_Search").html(chrome.i18n.getMessage("locale_Advanced_Search")), $(this.el).find(".locale_advanced_search_explaination").html(chrome.i18n.getMessage("locale_advanced_search_explaination")), $(this.el).find(".locale_AND").html(chrome.i18n.getMessage("locale_AND")), $(this.el).find(".locale_OR").html(chrome.i18n.getMessage("locale_OR")), this.advancedSearchDatumView.el = this.$(".advanced_search_datum"), this.advancedSearchDatumView.render(), this.advancedSearchSessionView.el = this.$(".advanced_search_session"), this.advancedSearchSessionView.render(), $("#search-top").html(this.topTemplate(this.model.toJSON())), $("#search-top").find(".locale_Search_Tooltip").attr("title", chrome.i18n.getMessage
("locale_Search")), $("#search-top").find(".locale_Advanced_Search").html(chrome.i18n.getMessage("locale_Advanced_Search")), $("#search-top").find(".locale_Advanced_Search_Tooltip").attr("title", chrome.i18n.getMessage("locale_Advanced_Search_Tooltip")), this;
        },
...
.render(), this.insertUnicodesView.render(), this.searchEditView.format = "centreWell", this.searchEditView.render(), Utils.getVersion(function(e) {
            ...
            }), this.exportView.render()) : alert("	App model is not defined, this is a very big bug. Refresh your browser, and let us know about this " + Utils.contactUs), this.setTotalPouchDocs(), this.setTotalBackboneDocs(), $(this.el).find(".locale_Show_Dashboard").attr("title", chrome.i18n.getMessage("locale_Show_Dashboard")), $(this.el).find(".locale_Need_save").text(chrome.i18n.getMessage("locale_Need_save")), $(this.el).find(".locale_Recent_Changes").text(chrome.i18n.getMessage("locale_Recent_Changes")), $(this.el).find(".locale_Save_on_this_Computer").attr("title", chrome.i18n.getMessage("locale_Save_on_this_Computer")), $(this.el).find(".locale_Need_sync").text(chrome.i18n.getMessage("locale_Need_sync")), $(this.el).find(".locale_Differences_with_the_central_server"
).text(chrome.i18n.getMessage("locale_Differences_with_the_central_server")), $(this.el).find(".locale_Sync_and_Share").attr("title", chrome.i18n.getMessage("locale_Sync_and_Share")), $(this.el).find(".locale_View_Public_Profile_Tooltip").attr("title", chrome.i18n.getMessage("locale_View_Public_Profile_Tooltip")), $(this.el).find(".locale_Instructions_to_show_on_dashboard").html(chrome.i18n.getMessage("locale_Instructions_to_show_on_dashboard")), $(this.el).find(".locale_to_beta_testers").html(chrome.i18n.getMessage("locale_to_beta_testers")), $(this.el).find(".locale_We_need_to_make_sure_its_you").html(chrome.i18n.getMessage("locale_We_need_to_make_sure_its_you")), $(this.el).find(".locale_Password").html(chrome.i18n.getMessage("locale_Password")), $(this.el).find(".locale_Yep_its_me").text(chrome.i18n.getMessage("locale_Yep_its_me")), this;
        },
...
.indexOf(e) == -1 && this.totalBackboneDocs.push(e), this.setTotalBackboneDocs();
        ...
        toastUser: function(e, t, n) {
            ...
            t || (t = ""), n || (n = chrome.i18n.getMessage("locale_Warning")), $("#toast-user-area").append("<div class='alert " + t + " alert-block'>" + "<a class='close' data-dismiss='alert' href='#'>\u00d7</a>" + "<strong class='alert-heading'>" + n + "</strong> " + e + "</div>");
        },
...
e.which;
            ...
            "click .sync-sapir-data"
: function() {
                console.log("hiding user welcome, syncing sapir"), this.syncUser("sapir", "phoneme", Utils.authUrl);
            },
        ...
        render: function() {
            ...
            if (this.model != undefined) {
                this.model.set
("username", this.model.get("username").toLowerCase().replace(/[^0-9a-z]/g, "")), this.setElement($("#user-welcome-modal")), $(this.el).html(this.template(this.model.toJSON())), $(".registerusername").focus(), $(this.el).find(".locale_Close_and_login_as_Ed_Sapir").html(chrome.i18n.getMessage("locale_Close_and_login_as_Ed_Sapir")), $(this.el).find(".locale_Close_and_login_as_Ed_Sapir_Tooltip").attr("title", chrome.i18n.getMessage("locale_Close_and_login_as_Ed_Sapir_Tooltip")), $(this.el).find(".locale_Log_In").html(chrome.i18n.getMessage("locale_Log_In")), $(this.el).find(".locale_Username").html(chrome.i18n.getMessage("locale_Username")), $(this.el).find(".locale_Password").html(chrome.i18n.getMessage("locale_Password")), $(this.el).find(".locale_Sync_my_data_to_this_computer").html(chrome.i18n.getMessage("locale_Sync_my_data_to_this_computer")), $(this.el).find(".locale_An_offline_online_fieldlinguistics_database").html(chrome.i18n.getMessage("locale_An_offline_online_fieldlinguistics_database"
)), $(this.el).find(".locale_Create_a_new_user").html(chrome.i18n.getMessage("locale_Create_a_new_user")), $(this.el).find(".locale_New_User").text(chrome.i18n.getMessage("locale_New_User")), $(this.el).find(".locale_Confirm_Password").text(chrome.i18n.getMessage("locale_Confirm_Password")), $(this.el).find(".locale_Sign_in_with_password").text(chrome.i18n.getMessage("locale_Sign_in_with_password"));
                var e = this;
