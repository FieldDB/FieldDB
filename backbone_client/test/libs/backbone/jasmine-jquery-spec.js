...
describe("jasmine.Fixtures using real AJAX call", function() {
  ...
  beforeEach(function() {
    ...
    jasmine.getFixtures().fixturesPath = 'libs/backbone/fixtures'
  })
...
describe("jasmine.StyleFixtures using real AJAX call", function() {
  ...
  beforeEach(function() {
    ...
    jasmine.getStyleFixtures().fixturesPath = 'libs/backbone/fixtures'
  })
...
describe("jasmine.JSONFixtures using real AJAX call", function() {
  ...
  beforeEach(function() {
    ...
    jasmine.getJSONFixtures().fixturesPath = 'libs/backbone/fixtures/json'
  })
