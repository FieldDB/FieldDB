define([
  ...
  var DatumReadView = Backbone.View.extend( /** @lends DatumReadView.prototype */ {
    /**
    ...
    render: function() {
      ...
      if (this.format == "well") {
        ...
        var getLabels2patterns = function(queryTokens) {
          return list2object(_.map(_.filter(queryTokens, function(e, i) {
              return i % 2 === 0;
            }),
            function(s) {
              return s.split(':')
          ...
          if (fields && (fields.length > 0)) {
            for (var field in fields) {
              ...
              if (fields[field] &&
                ...
                jsonToRender.additionalFields.push({
