define([
  ...
  var AppView = Backbone.View.extend( /** @lends AppView.prototype */ {
    ...
    toastUser: function(message, alertType, heading) {
      ...
      $('#toast-user-area').prepend("<div class='alert " + alertType + " alert-block fade in'>" + "<a class='close' data-dismiss='alert' href='#'>x</a>" + "<strong class='alert-heading'>" + heading + "</strong> " + message + "</div>");
