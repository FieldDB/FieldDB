...
var Authentication = function Authentication(options) {
  ...
  try {
    ...
    self.warn("unable to save the user in local storage, this app wont be very usable offline ", e);
    key = "placeholder"
  }
  options = options || {};
  ...
  var self = this;
  FieldDB.Database.prototype.resumeAuthenticationSession().then(function(user) {
    self.debug(user);
    self.user = user;
    // self.user.fetch();
...
Authentication.prototype = Object.create(FieldDBObject.prototype, /** @lends Authentication.prototype */ {
   ...
   */
  authenticate: {
    value: function(user, successcallback, failcallback) {
      var dataToPost = {};
   ...
   *
   */
  saveServerResponseToUser: {
    value: function(serverResults, callbacksave) {
  ...
  loadEncryptedUser: {
    value: function(encryptedUserString, callbackload) {
  ...
  saveAndEncryptUserToLocalStorage: {
    value: function(callbacksaved) {
   ...
   */
  syncUserWithServer: {
    value: function(callback, corpusPouchName) {
      if (!corpusPouchName) {
        corpusPouchName = "";
      }
      if (!window.appView) {
  ...
  fetchListOfUsersGroupedByPermissions: {
    value: function(successcallback, failcallback) {
      var dataToPost = {};
      var authUrl = "";
      if (this.get("userPrivate") != undefined) {
