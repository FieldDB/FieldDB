define("comment/Comment", [ "use!backbone", ], function(Backbone) {
	var Comment = Backbone.Model.extend(

	/** @lends Comment.prototype */
	{
		/**
		 * @class Comments allow users to collaborate between each other and
		 *        take note of important things, issues to be fixed, etc. These
		 *        can appear on datum, sessions corpora, and dataLists. Comments
		 ...
		 * 
		 * @description Initialize function has a timestamp and a userid and
		 *              waits until text is entered.
		 * 
		...
		initialize : function() {
			...
			// TODO Set up any other bindings (i.e. what to do when certain
			// Events
			// happen). Example:
		...
		validate : function(attributes) {
			// This is used to validate any changes to the model. It is called
			// whenever
			// comment.set('someAttribute', __) is called, but before the
			// changes are
			// actually made to someAttribute.

			// TODO Validation on the attributes. Returning a String counts as
			// an error. Example:
