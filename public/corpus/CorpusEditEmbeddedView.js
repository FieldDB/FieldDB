...
define([ 
    ...
    Backbone, 
    Handlebars, 
    corpusEditEmbeddedTemplate, 
    Corpus
) {
      var CorpusEditEmbeddedView = Backbone.View
          .extend(
...
//              "change" : "render",
             ...
             */
            template : Handlebars.compile(corpusEditEmbeddedTemplate),

            /**
             * Renders the CorpusView and all of its child Views.
             */
            render : function() {
              Utils.debug("CORPUS edit embedded render: " + this.el);
              if (this.model != undefined) {
                // Display the CorpusView
                this.setElement($("#corpus-edit-embedded"));
