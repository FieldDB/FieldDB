define(["use!backbone"], function(Backbone) {
	/**
	 * @class Utils provides a number of utility functions which are handy around the  app. 
	 * @property {Boolean} debugMode This boolean can be changed from true to false for production mode to speed up the app.   
	 * 
	 * @constructs
	 */
	var Utils = function() {
		var debugMode = true;
		/**
		 * Console logs out, if not on Internet Explorer. Only logs out if debugMode is true. 
		 */
		 ...
		 * 
		 * Note: to Android app developers, append this to your user agent string to take advantage of the offline functionality of this app.  
