...
angular.module('fielddbAngularApp').controller('FieldDBController', ['$scope', '$routeParams', '$rootScope',
  function($scope, $routeParams, $rootScope) {
    ...
    $rootScope.getUserPreferences = function() {
      if ($scope.authentication && $scope.authentication.user && $scope.authentication.user.prefs) {
        return $scope.authentication.user.prefs;
      }
    };

    $rootScope.enterDecryptedMode = function() {
      var deferred = FieldDB.Q.defer();
      FieldDB.Q.nextTick(function() {
        if ($scope.authentication && $scope.authentication.user && $scope.authentication.user.authenticated) {
