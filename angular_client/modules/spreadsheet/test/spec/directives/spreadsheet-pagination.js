...
xdescribe('Directive: spreadsheet-pagination', function() {

  // load the directive's module and the template
  beforeEach(module('spreadsheetApp', 'views/pagination.html'));
  var el, scope, compileFunction;

  beforeEach(inject(function($rootScope, $compile) {
    el = angular.element('<div data-spreadsheet-pagination ></div>');
    scope = $rootScope.$new();
    scope.data = [];
  ...
  it('should make a pagination element with contents from scope', function() {
