...
xdescribe('Directive: spreadsheet-mcgill-spring2014-template-edit', function() {

  // load the directive's module and the template
  beforeEach(module('spreadsheetApp', 'views/mcgillfieldmethodsspring2014template-edit.html'));
  var el, scope, compileFunction;

  beforeEach(inject(function($rootScope, $compile) {
    el = angular.element('<div data-spreadsheet-mcgill-spring2014-template-edit ></div>');
    scope = $rootScope.$new();
    scope.data = [];
