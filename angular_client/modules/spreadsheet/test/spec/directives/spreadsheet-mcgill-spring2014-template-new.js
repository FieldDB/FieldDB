...
xdescribe('Directive: spreadsheet-mcgill-spring2014-template-new', function() {

  // load the directive's module and the template
  beforeEach(module('spreadsheetApp', 'views/mcgillfieldmethodsspring2014template-new.html'));
  var el, scope, compileFunction;

  beforeEach(inject(function($rootScope, $compile) {
    el = angular.element('<div data-spreadsheet-mcgill-spring2014-template-new ></div>');
    scope = $rootScope.$new();
    scope.data = [];
