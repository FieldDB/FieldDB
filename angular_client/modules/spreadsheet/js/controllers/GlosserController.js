console.log("Loading the SpreadsheetStyleDataEntryGlosserController.");
...
define([ "angular" ], function(angular) {
  ...
  function($scope, $rootScope, $resource, $filter, Data) {
    ...
    // var corpusSize = 31; // TODO get corpus size another way. //
    // //
    // app.get("corpus").datalists.models[app.get("corpus").datalists.models.length-1].get("datumIds").length;
    // if(corpusSize > 30 && !Glosser.toastedUserToSync){
    // Glosser.toastedUserToSync = true;
    // window.appView.toastUser("You probably have enough data to train an
    // autoglosser for your corpus.\n\nIf you sync your data with the team
    // server
    // then editing the morphemes will automatically run the auto
    // glosser.","alert-success","Sync to train your auto-glosser:");
    // }else{
    // Glosser.toastedUserToImport ++;
    // if(Glosser.toastedUserToImport % 10 == 1 && corpusSize < 30){
    // window.appView.toastUser("You have roughly "+corpusSize+" datum saved in
    // your
    // pouch, if you have around 30 datum, then you have enough data to train an
    // autoglosser for your corpus.","alert-info","AutoGlosser:");
    // }
    // }
    // return "";
    // }
    ...
    // var matchingNode = _.max(lexiconNodes.where({morpheme: morphemes[m]}),
    // function(node) { return node.get("value"); });
    ...
    // };
    // /**
    // * Takes as a parameters an array of rules which came from CouchDB
    // precedence
    // * rule query. Example Rule:
    // *
    // {"key":{"x":"@","relation":"preceeds","y":"aqtu","context":"aqtu-nay-wa-n"},"value":2}
    // */
    ...
    // }
    // /*
    // * Cycle through the precedence rules, convert them into graph edges with
    // the
    // * morpheme index in the morpheme array as the source/target values
    // */
    // morphemeLinks = [];
    // morphemes = [];
    // for ( var i in rules) {
    ...
    //  
    // /*
    // * Build the morphemes into nodes and color them by their morpheme length,
    // * could be a good measure of outliers
    // */
    // var morphemenodes = [];
    // for (m in morphemes) {
    // morphemenodes.push({
    ...
    //  
    // var svg =
    // d3.select("#corpus-precedence-rules-visualization-fullscreen").append("svg")
    // .attr("width", width)
    ...
    // titletext = "Your morpheme visualizer will appear here after you have
    // synced.";
    // }
