    ...
    function(angular) {
      var LingSyncSpreadsheetDirectives = angular
          ...
          .directive(
              ...
              function() {
                return function(scope, element, attrs) {
                  if (scope.scopePreferences && scope.field.label == scope.scopePreferences.template1[attrs.selectDropdown1].label) {
          ...
          .directive(
              ...
              function() {
                return function(scope, element, attrs) {
                  if (scope.scopePreferences && scope.field.label == scope.scopePreferences.template2[attrs.selectDropdown2].label) {
                    element[0].selected = true;
                  }
                };
