 ...
 *
 * <pre>
 *   ActivityFeedDev = angular.module('ActivityFeedDev', ['ActivityFeed', 'ngMockE2E']);
 *   ActivityFeedDev.run(function($httpBackend) {
...
window.jasmine && (function(window) {
   ...
   * <pre>
   *
   *   angular.module('ActivityFeedlicationModule', [])
   *       .value('mode', 'app')
   ...
   *     beforeEach(module('ActivityFeedlicationModule'));
   *
   *
