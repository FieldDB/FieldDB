function(doc) {
  if (doc._id && doc.status != "Archived" && doc.status != "Transferred") {
    emit(doc._id, {
      ...
      assignment_date_first_retrieved : doc.header.assignment.date_first_retrieved.replace(/ \d\d:\d\d:\d\d.*/g,""),
      purchaseOrder : doc.header.purchaseOrder,
      purchaseOrder_number : doc.header.purchaseOrder.number,
      purchaseOrder_order_date : doc.header.purchaseOrder.order_date.replace("00:00:00",""),
