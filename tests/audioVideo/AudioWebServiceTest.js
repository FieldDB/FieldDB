require(
    [ "../tests/audioVideo/AudioService", "../tests/corpus/CouchDBConnection" ],
    function(AudioService, CorpusDBConnection) {
      ...
      var runCORSTests = function(whichServer) {
        ...
        it(
            ...
            function() {
               ...
               */ 
              var corpus = new CorpusDBConnection(corpusServerUrl, user);
