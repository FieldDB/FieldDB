    ...
    "datum/Datum"
		...
		describe("Test Datums", function() {
			it("should print collection", function(){
				...
				expect(JSON.stringify(dc)).toEqual('[{"utterance":"tusunayawanmi","gloss":"dance-IMP-1OM-3SG","translation":"I feel like dancing.","grammaticalTags":"impulsative","sessionID":0,"status":{"statuses":[{"id":1,"label":"Checked"},{"id":2,"label":"To be checked","selected":true},{"id":3,"label":"Deleted"}],"active":0,"defaultStatus":0},"datumMenu":{},"datumField":{"script":"","context":"","semanticDenotation":"","ipa":"","segmentation":"tusu-naya-wa-n","other":""},"datumTag":{}},{"utterance":"purunaywanmi","gloss":"dance-IMP-1OM-3SG","translation":"I feel like dancing.","grammaticalTags":"impulsative","sessionID":0,"status":{"statuses":[{"id":1,"label":"Checked"},{"id":2,"label":"To be checked","selected":true},{"id":3,"label":"Deleted"}],"active":0,"defaultStatus":0},"datumMenu":{},"datumField":{"script":"","context":"","semanticDenotation":"","ipa":"","segmentation":"tusu-naya-wa-n","other":""},"datumTag":{}},{"utterance":"allillanchu","gloss":"dance-IMP-1OM-3SG","translation":"I feel like dancing.","grammaticalTags":"impulsative","sessionID":0,"status":{"statuses":[{"id":1,"label":"Checked"},{"id":2,"label":"To be checked","selected":true},{"id":3,"label":"Deleted"}],"active":0,"defaultStatus":0},"datumMenu":{},"datumField":{"script":"","context":"","semanticDenotation":"","ipa":"","segmentation":"tusu-naya-wa-n","other":""},"datumTag":{}}]');
			});
