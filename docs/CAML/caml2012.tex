...
To maintain simple and clean user interface, various functions in LingSync are organized into widgets (e.g. data entry widget, search widget). % LingSync employs CouchDB, a NoSQL database, 
