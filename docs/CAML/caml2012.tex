...
\firsttitle{\LARGE LingSync:  \Large A Free Tool for Creating and \\Maintaining a Shared Database For Communities, Linguists and Language Learners}
\runningtitle{LingSync}

\author{MaryEllen Cathcart$^{a,b}$ Gina Chiodo$^b$  Theresa Deering$^{b,c}$ Yuliya Manyakina$^{d}$ Gretchen McCulloch$^d$ Hisako Noguchi$^e$}
...
\ex Data is open-ended, yet consistent
 ...
 \centering
    \includegraphics[width=0.35\textwidth]{../figures/typeaheadForPreviousCategories}
...
\begin{exe} 
\ex Data is stored as plain text in Unicode\footnote{For more examples of LingSync's data schema see\\ https://github.com/FieldDB/FieldDB/tree/master/tests}

 \centering
    \includegraphics[width=0.8\textwidth]{../figures/dataIsPlainTextUnicode}
...
\ex Data is searchable both for normal users, and for power users
 ...
 \centering
    \includegraphics[width=0.4\textwidth]{../figures/searchable}
...
\ex \label{ex:discoverable}  ~  \\ 
 ...
 a. Data can be search engine discoverable & b. Fields can be public yet masked \\
   \includegraphics[width=0.4\textwidth]{../figures/discoverable} & 
   \includegraphics[width=0.4\textwidth]{../figures/confidential}
\end{tabular}
...
\ex Data can be fully replicated in its entirety across multiple servers
 ...
 \centering
   \includegraphics[width=0.8\textwidth]{../figures/accessible}
...
\ex Teams can have custom terms of use
 ...
 \centering
   \includegraphics[width=0.8\textwidth]{../figures/customtermsOfUse}
...
\ex \label{ex:bots}  ~  \\ 
 ...
 a.  Bots can recommend changes and & b.  leave explanations of what was changed \\
   \includegraphics[width=0.45\textwidth]{../figures/cleaningBotsDatalist} &
   \includegraphics[width=0.45\textwidth]{../figures/cleaningBotCameBy}
\end{tabular}
\end{exe}
...
\ex \label{ex:glosser}  ~  \\ 
 ...
 a. Morpheme segmentation  & b. uses precedence relations in your corpus\\
  \includegraphics[width=0.4\textwidth]{../figures/glosser} &
   \includegraphics[width=0.4\textwidth]{../figures/morphemePrecedenceRelations}
\end{tabular}
\end{exe}
...
\ex Activity feeds let team members catch up on recent changes in the database
 \centering
   \includegraphics[width=0.7\textwidth]{../figures/activityfeeds} 
...
Sample  services which can wrap Bash/Python/Perl scripts  into RESTful web services are provided on the FieldDB GitHub. https://github.com/FieldDB %\citep{Desilets:2010}
}
...
\centering
   \includegraphics[width=0.9\textwidth]{../figures/spreadsheetcompact}
...
The Inuktitut glosser took Farley over five years to build and test, and four days to wrap as a web service.\footnote{https://github.com/FieldDB/LexiconWebService}%refer to somewhere for more details? %where did the Inuktitut corpus/corpora live, on our servers or somewhere online? 
...
\ex The Language Learning prototype is downloadable on Google Play\footnote{https://play.google.com/store/apps/details?id=com.github.opensourcefieldlinguistics.android.lessons}
 ...
 \centering
   \includegraphics[width=0.7\textwidth]{../figures/languageLearningApp} 
...
saving hours of boundary tagging. The ProsodyLab took roughly two years to build and test the aligner, and it took two weeks to wrap it as a web service.\footnote{https://github.com/FieldDB/AudioWebService}
