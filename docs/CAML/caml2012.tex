...
rather than dividing their attention between the speaker and the process of data entry.\footnote{For example, Cox \citep{Cox:2013} considers recording speech and its free translation orally provided by language consultants, when balanced with a careful review, as a rapid yet valid annotation method alongside written transcription and annotation. } 
