...
but rather the video recording of an elicitation session followed by transcribing the session at a later date.\footnote{For example, Cox's two-stage Basic Oral Annotation method \citep{Cox:2013} utilizes commentary orally provided by language consultants for more careful, targeted annotation at a later time. } 
