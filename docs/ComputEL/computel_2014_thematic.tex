...
%\smalltodo{It seems tautologous to say that curation software requires curation.}
...
%\caption{Screenshot of the utterance extraction results, a web service which
%converts any audio video into utterance intervals which can be converted into
%JSON using the PraatTextGridJS library can be converted into datum in LingSync.}
