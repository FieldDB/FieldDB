...
\note[item]{Linguistic diversity and language vitality are valuable from a
    number of perspectives. For those who might be skeptical of a strong link
...
\begin{itemize}
    \item<1-> Documentation, description, and/or theoretical analysis?
        ...
        \note[item]<1>{First, there is some disagreement over how we should
            approach the urgent problem of language endangerment.}
        \begin{itemize}
            ...
            \item<4->Theoretical linguistic analysis uncovers previously
                ...
                \note[item]<4>{There is a related debate over the role of
                    ...
                    responding in defence of a hypothesis-driven approach and its
        ...
        \begin{itemize}
            ...
            \item<7->Lone wolf linguistics is not necessarily unethical linguistics (Crippen \& Robinson 2013)
                \note[item]<7>{Others point out that, for a variety of reasons,
                    ...
                    endangerment are themselves diverse. Not all communities desire or
...
\note[item]<4>{The software should allow for the inclusion of the various
    ...
    interested community members, and to fieldworkers engaged in
...
\note[item]<1>{This next diagram depicts LingSync corpora.}
\note[item]<1>{A fieldworker can create any number of corpora. A fieldworker
...
\note[item]<1>{Finally, LingSync implements version control, meaning that all
