...
% BEGIN COMMENTED OUT VERSION OF PAPER AS IT WAS ON THU, APR 24, 2014, 16:34 PST
\begin{comment}
...
collaborative and inclusive linguistic fieldwork. This paper presents the \glspl{api}
...
\subsection{Really discuss the private data issue}

``The so-called `discussion' of `the importance of allowing contributors to
keep certain data private while also assisting language communities in
developing \ldots' is not so much a discussion as it is a statement to the effect
that communities should have the right to keep certain data private. This is
totally superfluous. A more appropriate discussion is to what extent the
scientific community should bother with private data and to what extent
technology for such belongs in scientific conferences.''
...
web apps which facilitate collaborative linguistic fieldwork. 
...
% END COMMENTED OUT VERSION OF PAPER
